...
.. note::
   ...
   .. treeview::
      ...
      - :dir:`folder` |MNH_directory_extract_current|/examples/tutorials/ideal_cases/3D_ideal_surface/
...
.. tip::
   ...
   .. code-block:: bash
      ...
      |MNH_directory_extract_current|/examples/tutorials/ideal_cases/3D_ideal_surface/001_prep_ideal_case/
...
.. code-block:: bash
   ...
   cd |MNH_directory_extract_current|/examples/tutorials/ideal_cases/3D_ideal_surface/001_prep_ideal_case/
...
.. tip::
   ...
   .. code-block:: bash
      ...
      |MNH_directory_extract_current|/examples/tutorials/ideal_cases/3D_ideal_surface/002_mesonh/
...
.. code-block:: bash
   ...
   cd |MNH_directory_extract_current|/examples/tutorials/ideal_cases/3D_ideal_surface/002_mesonh/
   ./run_mesonh.sh
...
.. code-block:: bash
   ...
   cd |MNH_directory_extract_current|/examples/tutorials/ideal_cases/3D_ideal_surface/003_python/
   ./run_python.sh
...
.. tip::
   ...
   .. code-block:: bash
      ...
      |MNH_directory_extract_current|/examples/tutorials/ideal_cases/3D_ideal_surface/003_python/
