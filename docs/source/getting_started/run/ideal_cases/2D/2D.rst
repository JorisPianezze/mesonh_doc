...
.. note::
   ...
   .. treeview::
      ...
      - :dir:`folder` |MNH_directory_extract_current|/examples/tutorials/ideal_cases/2D/
...
.. tip::
   ...
   .. code-block:: bash
      ...
      |MNH_directory_extract_current|/examples/tutorials/ideal_cases/2D/001_prep_ideal_case/
...
.. code-block:: bash
   ...
   cd |MNH_directory_extract_current|/examples/tutorials/2D/001_prep_ideal_case/
...
.. treeview::
   ...
   - :dir:`folder` |MNH_directory_extract_current|/examples/tutorials/ideal_cases/2D/001_prep_ideal_case/
...
.. tip::
   ...
   .. code-block:: bash
      ...
      |MNH_directory_extract_current|/examples/tutorials/ideal_cases/2D/002_mesonh/
...
.. code-block:: bash
   ...
   cd |MNH_directory_extract_current|/examples/tutorials/ideal_cases/2D/002_mesonh/
   ./run_mesonh.sh
...
.. code-block:: bash
   ...
   cd |MNH_directory_extract_current|/examples/tutorials/ideal_cases/2D/003_python/
   ./run_python.sh
...
.. tip::
   ...
   .. code-block:: bash
      ...
      |MNH_directory_extract_current|/examples/tutorials/ideal_cases/2D/003_python/
