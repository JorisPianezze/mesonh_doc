...
.. csv-table:: NAM_DATA_TEB content 
...
* :code:`NPAR_ROOF_LAYER` : number of layers in roofs (-)

* :code:`NPAR_WALL_LAYER` : number of layers in walls (-)

* :code:`CBLD_ATYPE` : type of averaging for building (-)
...
* :code:`NUNIF_BLDTYPE / CFNAM_BLDTYPE / CFTYP_BLDTYPE` : identifier for building type \\ \\

* :code:`NUNIF_IND_BLD_AGE / CFNAM_IND_BLD_AGE / CFTYP_IND_BLD_AGE` : identifier for construction period of buildings with individual housing use

* :code:`NUNIF_COL_BLD_AGE / CFNAM_COL_BLD_AGE / CFTYP_COL_BLD_AGE` : identifier for construction period of buildings (collective housing) \\ \\

* :code:`NUNIF_USETYPE / CFNAM_USETYPE / CFTYP_USETYPE` : Identifier for building use \\ \\

* :code:`NUNIF_P1TERRITORY / CFNAM_P1TERRITORY / CFTYP_P1TERRITORY` : Identifier for construction material of historical buildings (before 1948). The P1 territory describes the dominant construction materials for historical buildings (construction period P1). For P1, there is a large variety of materials used for the walls. The identifiers 4 to 19 are related to the P1 territory. (see table below)

* :code:`NUNIF_PXTERRITORY / CFNAM_PXTERRITORY / CFTYP_PXTERRITORY` : Identifier for construction material of recent buildings (after 1948). The PX territory describes the dominant construction material for the more recent buildings. The identifiers 1 to 3 are related to the PX territory. (see table below)  \\ \\

* :code:`XUNIF_FRACIHS / CFNAM_FRACIHS / CFTYP_FRACIHS` : individual housing fraction

* :code:`XUNIF_FRACCHS / CFNAM_FRACCHS / CFTYP_FRACCHS` : collective housing fraction

* :code:`XUNIF_FRACCOM / CFNAM_FRACCOM / CFTYP_FRACCOM` : fraction of commercial building use

* :code:`XUNIF_FRACTER / CFNAM_FRACTER / CFTYP_FRACTER` : fraction of tertiary building use

* :code:`XUNIF_FRACIND / CFNAM_FRACIND / CFTYP_FRACIND` : fraction of industrial building use

* :code:`XUNIF_FRACNHE / CFNAM_FRACNHE / CFTYP_FRACNHE` : fraction of non heated buildings

* :code:`XUNIF_FRACPAV / CFNAM_FRACPAV / CFTYP_FRACPAV` : fraction of low-rise building types

* :code:`XUNIF_FRACMRI / CFNAM_FRACMRI / CFTYP_FRACMRI` : fraction of mid-rise building types

* :code:`XUNIF_FRACHRI / CFNAM_FRACHRI / CFTYP_FRACHRI` : fraction of high-rise building types

* :code:`XUNIF_FRACATB / CFNAM_FRACATB / CFTYP_FRACATB` : fraction of activity buildings

* :code:`XUNIF_FOEQI_MAIS / CFNAM_FOEQI_MAIS / CFTYP_FOEQI_MAIS` : fraction of strong equipment and use in individual housing (-)

* :code:`XUNIF_FOEQI_APPT / CFNAM_FOEQI_APPT / CFTYP_FOEQI_APPT` : fraction of strong equipment and use in collective housing (-)

* :code:`XUNIF_FAEQI_MAIS / CFNAM_FAEQI_MAIS / CFTYP_FAEQI_MAIS` : fraction of weak equipment and use in individual housing (-)

* :code:`XUNIF_FAEQI_APPT / CFNAM_FAEQI_APPT / CFTYP_FAEQI_APPT` : fraction of weak equipment and use in collective housing (-)

* :code:`XUNIF_CRE_MAIS / CFNAM_CRE_MAIS / CFTYP_CRE_MAIS` : fraction of high regulation in individual housing (-)

* :code:`XUNIF_CRE_APPT / CFNAM_CRE_APPT / CFTYP_CRE_APPT` : fraction of high regulation in collective housing (-)

* :code:`XUNIF_ALB_ROOF / CFNAM_ALB_ROOF / CFTYP_ALB_ROOF` : roof albedo (-)

* :code:`XUNIF_EMIS_ROOF / CFNAM_EMIS_ROOF / CFTYP_EMIS_ROOF` : roof emissivity (-)

* :code:`XUNIF_HC_ROOF / CFNAM_HC_ROOF / CFTYP_HC_ROOF` : roof layers heat capacity (J/K/m$^{3}$)

* :code:`XUNIF_TC_ROOF / CFNAM_TC_ROOF / CFTYP_TC_ROOF` : roof layers thermal conductivity (W/K/m)

* :code:`XUNIF_D_ROOF / CFNAM_D_ROOF / CFTYP_D_ROOF` : roof layers depth (m)

* :code:`XUNIF_ALB_ROAD / CFNAM_ALB_ROAD / CFTYP_ALB_ROAD` : road albedo (-)

* :code:`XUNIF_EMIS_ROAD / CFNAM_EMIS_ROAD / CFTYP_EMIS_ROAD` : road emissivity (-)

* :code:`XUNIF_HC_COATING_ROAD / CFNAM_HC_COATING_ROAD / \\`

* :code:`XUNIF_TC_COATING_ROAD / CFNAM_TC_COATING_ROAD / \\`

* :code:`XUNIF_D_COATING_ROAD / CFNAM_D_COATING_ROAD / \\`

* :code:`XUNIF_HC_BASEMENT_ROAD / CFNAM_HC_BASEMENT_ROAD / \\`

* :code:`XUNIF_TC_BASEMENT_ROAD / CFNAM_TC_BASEMENT_ROAD / \\`

* :code:`XUNIF_ALB_WALL / CFNAM_ALB_WALL / CFTYP_ALB_WALL` : wall albedo (-)

* :code:`XUNIF_EMIS_WALL / CFNAM_EMIS_WALL / CFTYP_EMIS_WALL` : wall emissivity (-)

* :code:`XUNIF_HC_WALL / CFNAM_HC_WALL / CFTYP_HC_WALL` : wall layers heat capacity (J/K/m$^{3}$)

* :code:`XUNIF_XUNIF_TC_WALL / CFNAM_XUNIF_TC_WALL / CFTYP_XUNIF_TC_WALL` : wall layers thermal conductivity (W/K/m)

* :code:`XUNIF_D_WALL / CFNAM_D_WALL / CFTYP_D_WALL` : wall layers depth (m)

* :code:`XUNIF_Z0_TOWN / CFNAM_Z0_TOWN / CFTYP_Z0_TOWN` : roughness length for momentum (m)

* :code:`XUNIF_BLD / CFNAM_BLD / CFTYP_BLD` : fraction of buildings (-)

* :code:`XUNIF_ROAD / CFNAM_ROAD / CFTYP_ROAD` : fraction of road (-)

* :code:`XUNIF_BLD_HEIGHT / CFNAM_BLD_HEIGHT / CFTYP_BLD_HEIGHT` : buildings height (m)

* :code:`XUNIF_WALL_O_HOR / CFNAM_WALL_O_HOR / CFTYP_WALL_O_HOR` : ratio between facade and urban horizontal surface (-)

* :code:`XUNIF_H_TRAFFIC / CFNAM_H_TRAFFIC / CFTYP_H_TRAFFIC` : anthropogenic sensible heat fluxes due to traffic (W/m$^{2}$)

* :code:`XUNIF_LE_TRAFFIC / CFNAM_LE_TRAFFIC / CFTYP_LE_TRAFFIC` : anthropogenic latent heat fluxes due to traffic (W/m$^{2}$)

* :code:`XUNIF_H_INDUSTRY / CFNAM_H_INDUSTRY / CFTYP_H_INDUSTRY` : anthropogenic sensible heat fluxes due to factories (W/m$^{2}$)

* :code:`XUNIF_LE_INDUSTRY / CFNAM_LE_INDUSTRY / CFTYP_LE_INDUSTRY` : anthropogenic latent heat fluxes due to factories (W/m$^{2}$)

* :code:`XUNIF_ROAD_DIR / CFNAM_ROAD_DIR / CFTYP_ROAD_DIR` : road direction (in degrees from North clockwise)

* :code:`XUNIF_GREENROOF / CFNAM_GREENROOF / CFTYP_GREENROOF` : fraction of greenroofs on roofs (-)

* :code:`XUNIF_FRAC_HVEG / CFNAM_FRAC_HVEG / CFTYP_FRAC_HVEG` : fraction of high vegetation (-)

* :code:`XUNIF_FRAC_LVEG / CFNAM_FRAC_LVEG / CFTYP_FRAC_LVEG` : fraction of low vegetation (-)

* :code:`XUNIF_FRAC_NVEG / CFNAM_FRAC_NVEG / CFTYP_FRAC_NVEG` : fraction of bare soil (-)

* :code:`XUNIF_ROUGH_ROOF / CFNAM_ROUGH_ROOF / CFTYP_ROUGH_ROOF` : roof roughness coefficient

* :code:`XUNIF_ROUGH_WALL / CFNAM_ROUGH_WALL / CFTYP_ROUGH_WALL` : wall roughness coefficient

* :code:`XUNIF_EMIS_PANEL / CFNAM_EMIS_PANEL / CFTYP_EMIS_PANEL` : emissivity of solar panel

* :code:`XUNIF_ALB_PANEL / CFNAM_ALB_PANEL / CFTYP_ALB_PANEL` : albedo of solar panel

* :code:`XUNIF_EFF_PANEL / CFNAM_EFF_PANEL / CFTYP_EFF_PANEL` : efficiency of solar panel

* :code:`XUNIF_FRAC_PANEL / CFNAM_FRAC_PANEL / CFTYP_FRAC_PANEL` : fraction of solar panel

* :code:`XUNIF_NB_POP / CFNAM_NB_POP / CFTYP_NB_POP` : population density (1/km$^{2}$)

* :code:`XUNIF_SFCO2_RD / CFNAM_SFCO2_RD / CFTYP_SFCO2_RD` : CO$_{2}$ flux due to traffic (kg/s/m$^{2}$)

* :code:`XUNIF_DELTA_LEGAL_TIME / CFNAM_DELTA_LEGAL_TIME / \\`

* :code:`XUNIF_TIME_OF_CHANGE` : time of time change of the legal hour

* :code:`XUNIF_POP_MONTHLY` : monthly cycle of inhabitants density

* :code:`XUNIF_POP_DAILY` : daily cycle of inhabitants density

* :code:`XUNIF_POP_HOURLY` : hourly cycle of inhabitants density

* :code:`XUNIF_TRAF_MONTHLY` : monthly cycle of traffic

* :code:`XUNIF_TRAF_DAILY` : daily cycle of traffic

* :code:`XUNIF_TRAF_HOURLY` : hourly cycle of traffic
