...
Since RTTOV requires a license agreement, no RTTOV package is included in the open source version of Meso-NH. However, a subroutine calling RTTOV14 is included in Meso-NH version 60. To compile and use Meso-NH with RTTOV, you must follow the instructions in :ref:`compile_mesonh_with_rttov`.
